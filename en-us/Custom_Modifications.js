        ...
        oEffects.TextEffects.ShakeText = function(json){
            if(!json.customSize){
                json.customSize = function(i){
                    let size = -1;
                    let sizes = [1025,938,1100,1025,900,850,1125,950,550,750,1012,1100,1225,1125,1100,1000,1100,920,900,1000,1000,1300,1400,1087,1037,887];
                    let sizes_lower = [1025,938,1000,1025,900,775,1100,850,550,750,800,950,1325,1025,1200,900,1100,987,737,900,1000,1200,1300,950,1037,887];
                    if(i>='A'&&i<='Z'){
