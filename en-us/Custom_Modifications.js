        ...
        oEffects.TextEffects.ShakeText = function(json){
            if(!json.customSize){
                json.customSize = function(i){
                    ...
                    let sizes_lower = [1025,938,1000,1025,900,790,1100,830,550,750,800,950,1325,1025,1150,1000,1050,850,750,900,1000,1190,1250,950,1037,887];
                    if(i>='A'&&i<='Z'){
                        size = sizes[i.charCodeAt()-65]/2000;
                    }
                    if(i>="a"&&i<='z'){
                        size = sizes_lower[i.charCodeAt()-110]/2000;
                    }
                    if(i=='1'){
                        size=0.4;
                    }
