        ...
        oEffects.TextEffects.ShakeText = function(json){
            if(!json.customSize){
                json.customSize = function(i){
                    let size = -1;
                    let sizes = [1025,938,825+125,1025,900,775,1125,950,550,750,1012,900,1225,1125,1100,1000,1100,987,800,1000,1000,1230,1300,1087,1037,887];
                    let sizes_lower = [1025,938,825+125,1025,900,775,1125,950,550,750,1012,850,1325,1025,1200,900,1100,987,737,900,1000,1272,1400,1087,1037,887];
                    if(i>='A'&&i<='Z'){
