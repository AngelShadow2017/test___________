        ...
        oEffects.TextEffects.ShakeText = function(json){
            if(!json.customSize){
                json.customSize = function(i){
                    let size = -1;
                    let sizes = [1025,938,1050,1025,900,910,1125,900,560,790,1012,1100,1225,1125,1100,1000,1100,920,900,1000,1050,1350,1350,1070,1037,900];
                    let sizes_lower = [985,930,965,1005,870,800,1040,790,570,800,760,1030,1250,1025,1090,1000,1000,800,800,880,1010,1130,1160,970,1010,887];
                    if(i>='A'&&i<='Z'){
